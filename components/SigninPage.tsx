        ...
        <div className="w-full space-y-6">
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-[12px] text-blue-600 hover:underline font-semibold">
                  Forgot password?
                </Link>
              </div>
              <input 
          ...
          <div className="text-center pt-2">
            <p className="text-[14px] text-slate-600 dark:text-slate-300">
              New to CardMarketCap? <Link href="/sign-up" className="text-blue-600 hover:underline font-semibold">Create an account</Link>
            </p>
          </div>
        </div>
      </div>
