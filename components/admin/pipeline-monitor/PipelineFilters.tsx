...
import { Layers, ArrowUpRight, Percent, ShieldAlert, Image, LucideIcon } from 'lucide-react';
import { cn } from "@/lib/utils";

interface PipelineFiltersProps {
  activeTab: 'all' | 'ebay' | 'price_charting' | 'psa' | 'cdn';
  setActiveTab: (tab: 'all' | 'ebay' | 'price_charting' | 'psa' | 'cdn') => void;
  searchQuery: string;
...
export default function PipelineFilters({
  ...
  const tabs: { id: 'all' | 'ebay' | 'price_charting' | 'psa' | 'cdn'; label: string; icon: LucideIcon }[] = [
    ...
    { id: 'cdn', label: 'CDN Optimize', icon: Image },
  ];
  ...
  return (
    <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 w-full pt-1">
      ...
      <div className="relative w-full lg:w-96 font-inter">
        ...
        <input 
          type="text"
          placeholder="Search job logs or exceptions..."
          value={searchQuery}
