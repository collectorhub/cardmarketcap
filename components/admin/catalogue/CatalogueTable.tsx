  ...
  return (
    <>
      {Array.from({ length: 10 }).map((_, idx) => (
        <tr key={`catalogue-skeleton-${idx}`} className="animate-pulse">
          <td className="py-3 px-6 text-center">
            <div className="h-4 w-4 mx-auto rounded bg-slate-200 dark:bg-slate-800" />
          </td>

          <td className="py-3 px-6">
            <div className="flex items-center gap-5">
              <div className="h-12 w-9 rounded-md bg-slate-200 dark:bg-slate-800" />
          ...
          <td className="py-3 px-6">
            <div className="ml-auto h-5 w-20 rounded bg-slate-200 dark:bg-slate-800" />
            <div className="ml-auto mt-2 h-3 w-14 rounded bg-slate-100 dark:bg-slate-800/70" />
          </td>
          ...
          <td className="py-3 px-6">
            <div className="ml-auto h-5 w-16 rounded bg-slate-200 dark:bg-slate-800" />
            <div className="ml-auto mt-2 h-3 w-20 rounded bg-slate-100 dark:bg-slate-800/70" />
          </td>
          ...
          <td className="py-3 px-6 text-center">
            <div className="h-9 w-9 mx-auto rounded-xl bg-slate-200 dark:bg-slate-800" />
          </td>
        </tr>
      ))}
    </>
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl md:rounded-[1.5rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {isLoading ? (
                ...
                initialCards.map((card, idx) => {
                  const displayImg =
                    card.imageUrl || "https://pokecollectorhub.com/assets/placeholder.png";
                  const displayPrice = card.price || "$0.00";
                  const displayAvg = card.avgPrice || "$0.00";
        ...
        {(initialCards.length > 0 || isLoading) && (
